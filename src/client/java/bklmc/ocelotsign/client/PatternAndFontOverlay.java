...
public final class PatternAndFontOverlay {
    ...
    private static void renderFilterButtons(DrawContext context, TextRenderer textRenderer, int mouseX, int mouseY,
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            context.drawStrokedRectangle(bx, currentY, UIConstants.FILTER_BUTTON_WIDTH, UIConstants.FILTER_BUTTON_HEIGHT, borderColor);
    ...
    private static void renderReturnButton(DrawContext context, TextRenderer textRenderer, int mouseX, int mouseY,
        ...
        context.drawStrokedRectangle(returnBtnX, returnBtnY, UIConstants.RETURN_BUTTON_WIDTH, UIConstants.RETURN_BUTTON_HEIGHT, UIConstants.COLOR_BTN_BORDER);
