...
public final class GridRenderer {
    ...
    public static int renderWhitelistGrid(DrawContext context, TextRenderer textRenderer,
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            context.drawStrokedRectangle(x, pInsertBtnY, UIConstants.ITEM_SIZE, 12, borderColor);
    ...
    private static void renderTextureItem(DrawContext context, int x, int y, Identifier textureId) {
        ...
        context.drawStrokedRectangle(x, y, UIConstants.ITEM_SIZE, UIConstants.ITEM_SIZE, UIConstants.COLOR_ITEM_BORDER);
        int innerSize = UIConstants.ITEM_SIZE - borderSize * 2;
        context.drawTexture(RenderPipelines.GUI_TEXTURED, textureId, x + borderSize, y + borderSize, 0.0F, 0.0F, innerSize, innerSize, innerSize, innerSize);
    }
    ...
    public static int renderFontList(DrawContext context, TextRenderer textRenderer,
        ...
        for (int i = 0; i < fontItems.size(); i++) {
            ...
            context.drawStrokedRectangle(fontStartX, y, fontItemWidth, fontItemVisualHeight,
            ...
            context.drawStrokedRectangle(insertBtnX, y + 2, UIConstants.INSERT_BUTTON_WIDTH, 16, btnBorderColor);
