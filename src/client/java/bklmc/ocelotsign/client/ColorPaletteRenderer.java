...
public final class ColorPaletteRenderer {
    ...
    public static void render(DrawContext context, TextRenderer textRenderer, int mouseX, int mouseY,
        ...
        for (int i = 0; i < PALETTE_RGB.length; i++) {
            ...
            context.drawStrokedRectangle(swatchX, swatchY, SWATCH_SIZE, SWATCH_SIZE, UIConstants.COLOR_ITEM_BORDER);
            ...
            context.drawStrokedRectangle(btnX, btnY, copyBtnW, copyBtnH, UIConstants.COLOR_BTN_BORDER);
        ...
        context.drawStrokedRectangle(tableLeft, tableTop, tableWidth, totalH, UIConstants.COLOR_ITEM_BORDER);
        // 列分隔线
