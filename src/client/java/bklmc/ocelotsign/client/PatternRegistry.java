...
public final class PatternRegistry {
    ...
    public static void registerBuiltInPatterns() {
        ...
        mishangCategory.addSection(new PatternAndFontOverlay.H4Section(Text.translatable("ocelotsignmod.gui.sections.mishang_patterns"),
                ...
                new Identifier("ocelotsignmod", "textures/mishanguc_patterns/"))
                .setWhitelistMode()
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left.png"), "-pattern al", Text.translatable("ocelotsignmod.gui.pattern.arrow_left"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right.png"), "-pattern ar", Text.translatable("ocelotsignmod.gui.pattern.arrow_right"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-up.png"), "-pattern au", Text.translatable("ocelotsignmod.gui.pattern.arrow_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-down.png"), "-pattern ad", Text.translatable("ocelotsignmod.gui.pattern.arrow_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-thin.png"), "-pattern arrow-left-thin", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_thin"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right-thin.png"), "-pattern arrow-right-thin", Text.translatable("ocelotsignmod.gui.pattern.arrow_right_thin"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-up-thin.png"), "-pattern arrow-up-thin", Text.translatable("ocelotsignmod.gui.pattern.arrow_up_thin"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-down-thin.png"), "-pattern arrow-down-thin", Text.translatable("ocelotsignmod.gui.pattern.arrow_down_thin"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-up.png"), "-pattern alu", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right-up.png"), "-pattern aru", Text.translatable("ocelotsignmod.gui.pattern.arrow_right_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-down.png"), "-pattern ald", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right-down.png"), "-pattern ard", Text.translatable("ocelotsignmod.gui.pattern.arrow_right_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-turn-up.png"), "-pattern altu", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_turn_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right-turn-up.png"), "-pattern artu", Text.translatable("ocelotsignmod.gui.pattern.arrow_right_turn_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-turn-down.png"), "-pattern altd", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_turn_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-right-turn-down.png"), "-pattern artd", Text.translatable("ocelotsignmod.gui.pattern.arrow_right_turn_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-left-right.png"), "-pattern alr", Text.translatable("ocelotsignmod.gui.pattern.arrow_left_right"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/arrow-up-down.png"), "-pattern aud", Text.translatable("ocelotsignmod.gui.pattern.arrow_up_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/circle-small.png"), "-pattern circle-small", Text.translatable("ocelotsignmod.gui.pattern.circle_small"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/circle-medium.png"), "-pattern O", Text.translatable("ocelotsignmod.gui.pattern.circle_medium"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/ban.png"), "-pattern ban", Text.translatable("ocelotsignmod.gui.pattern.ban"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/u-turn-left-down.png"), "-pattern uld", Text.translatable("ocelotsignmod.gui.pattern.u_turn_left_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/u-turn-right-down.png"), "-pattern urd", Text.translatable("ocelotsignmod.gui.pattern.u_turn_right_down"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/u-turn-left-up.png"), "-pattern ulu", Text.translatable("ocelotsignmod.gui.pattern.u_turn_left_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/u-turn-right-up.png"), "-pattern uru", Text.translatable("ocelotsignmod.gui.pattern.u_turn_right_up"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/cross-small.png"), "-pattern cross-small", Text.translatable("ocelotsignmod.gui.pattern.cross_small"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/cross-medium.png"), "-pattern X", Text.translatable("ocelotsignmod.gui.pattern.cross_medium"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/cross-large.png"), "-pattern cross-large", Text.translatable("ocelotsignmod.gui.pattern.cross_large"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-small.png"), "-pattern square-small", Text.translatable("ocelotsignmod.gui.pattern.square_small"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-medium.png"), "-pattern square", Text.translatable("ocelotsignmod.gui.pattern.square_medium"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-large.png"), "-pattern square-large", Text.translatable("ocelotsignmod.gui.pattern.square_large"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-slant-small.png"), "-pattern small-slant-square", Text.translatable("ocelotsignmod.gui.pattern.square_slant_small"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-slant-medium.png"), "-pattern medium-slant-square", Text.translatable("ocelotsignmod.gui.pattern.square_slant_medium"))
                .addWhitelistItem(new Identifier("ocelotsignmod", "textures/mishanguc_patterns/square-slant-large.png"), "-pattern large-slant-square", Text.translatable("ocelotsignmod.gui.pattern.square_slant_large")));
        ...
        customPatternCategory.addSection(new PatternAndFontOverlay.H4Section(Text.translatable("ocelotsignmod.gui.sections.custom_patterns"),
                Text.literal(""), new Identifier("ocelotsignmod", "patterns/"))
        ...
        customFontCategory.addSection(new PatternAndFontOverlay.H4Section(Text.translatable("ocelotsignmod.gui.sections.custom_fonts"),
                Text.literal(""), new Identifier("ocelotsignmod", "fonts/"))
                .setFontMode()
