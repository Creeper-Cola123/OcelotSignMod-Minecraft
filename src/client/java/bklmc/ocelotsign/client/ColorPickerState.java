...
public final class ColorPickerState {
    ...
    public static void ensureSvTexture(float hue) {
        ...
        for (int y = 0; y < size; y++) {
            ...
            for (int x = 0; x < size; x++) {
                ...
                int g = (rgb >> 8) & 0xFF;
                int b = rgb & 0xFF;
                image.setColorArgb(x, y, (0xFF << 24) | (r << 16) | (g << 8) | b);
            }
        }
        ...
        tm.registerTexture(svTextureId, new net.minecraft.client.texture.NativeImageBackedTexture(() -> svTextureId.toString(), image));
    ...
    public static void drawStepButton(DrawContext context, TextRenderer textRenderer,
        ...
        context.drawStrokedRectangle(x, y, w, h_, UIConstants.COLOR_BTN_BORDER);
