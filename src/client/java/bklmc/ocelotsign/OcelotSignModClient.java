...
public class OcelotSignModClient implements ClientModInitializer {
    ...
    private void registerOverlayScreenEvents() {
        ScreenEvents.AFTER_INIT.register((client, screen, scaledWidth, scaledHeight) -> {
            ...
            ScreenMouseEvents.allowMouseClick(screen).register((screen1, context) -> {
            ...
            ScreenKeyboardEvents.allowKeyPress(screen).register((screen1, context) -> {
                int key = context.key();
                if (PatternAndFontOverlay.isVisible) {
            ...
            ScreenKeyboardEvents.allowKeyRelease(screen).register((screen1, context) -> {
