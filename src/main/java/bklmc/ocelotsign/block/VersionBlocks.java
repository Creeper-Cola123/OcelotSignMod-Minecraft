...
public class VersionBlocks {
    public static final Block VERSION_BLOCK_1_0_0 = registerWithItem("version_block_1_0_0", new Block(BlockBehaviour.Properties.of()
            .setId(OcelotSignMod.blockKey("version_block_1_0_0"))));
