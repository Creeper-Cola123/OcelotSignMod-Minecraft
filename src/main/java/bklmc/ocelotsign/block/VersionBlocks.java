...
public class VersionBlocks {
    ...
    public static final Block VERSION_BLOCK_1_0_1 = registerWithItem("version_block_1_0_1", new Block(AbstractBlock.Settings.create().registryKey(getBlockKey("version_block_1_0_1"))));
