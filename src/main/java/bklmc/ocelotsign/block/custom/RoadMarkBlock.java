...
public class RoadMarkBlock extends Block implements Waterloggable {
    ...
    public void registerModels(ModelProvider modelProvider, BlockStateModelGenerator blockStateModelGenerator) {
        ...
        final Identifier onSlabModelId = Identifier.of(modelId.getNamespace(), modelId.getPath() + "_on_slab");
    ...
    protected static class DirectionalFacing extends RoadMarkBlock {
        ...
        public void registerModels(ModelProvider modelProvider, BlockStateModelGenerator blockStateModelGenerator) {
            final TextureMap textures = TextureMap.all(texture);
            final Identifier modelId = ModelIds.getBlockModelId(this);
            final Identifier rotatedModelId = Identifier.of(modelId.getNamespace(), modelId.getPath() + "_rotated");
            final Identifier onSlabModelId = Identifier.of(modelId.getNamespace(), modelId.getPath() + "_on_slab");
            final Identifier onSlabRotatedModelId = Identifier.of(modelId.getNamespace(), modelId.getPath() + "_on_slab_rotated");
